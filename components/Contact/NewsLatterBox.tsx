...
const NewsLatterBox = () => {
  ...
  return (
    <div className="rounded-xl wow fadeInUp shadow-three dark:bg-gray-dark relative z-10 bg-white p-8 sm:p-11 lg:p-8 xl:p-11" data-wow-delay=".2s">
      <img
        src="/images/consult/branding.png" // Replace '/your-image.jpg' with the path to your image
