...
const SectionComp = ({ section1, section2, section3, title2ClassName }) => {
    useEffect(() => {
                  ...
                  >
                    <div className="mx-[-12px] flex flex-wrap">
                      <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                        {section1.list1.map((item, index) => (
                          <List key={index} text={item} />
                        ))}
                      </div>
                      <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                        {section1.list2.map((item, index) => (
                          <List key={index} text={item} />
                        ))}
                      </div>
                    </div>
              ...
              <div className="-mx-4 flex flex-wrap items-center">
                <div className="w-full px-4 lg:w-1/2">
                  ...
                  >
                    <div className="mx-[-12px] flex flex-wrap">
                      <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                        {section3.list1.map((item, index) => (
                          <List key={index} text={item} />
                        ))}
                      </div>
                      <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                        {section3.list2.map((item, index) => (
                          <List key={index} text={item} />
                        ))}
                      </div>
                    </div>
                ...
                <div className="w-full px-4 lg:w-1/2">
                  ...
                  >
                    <Image
                      src={section3.image.light}
                      alt="about-image"
                      fill
                      className="mx-auto max-w-full rounded-3xl drop-shadow-three dark:hidden dark:drop-shadow-none lg:mr-0"
                    />
                    <Image
                      src={section3.image.dark}
                      alt="about-image"
                      fill
                      className="mx-auto hidden max-w-full rounded-3xl drop-shadow-three dark:block dark:drop-shadow-none lg:mr-0"
                    />
