...
function page() {
  ...
  const section1 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/EmailMarketing.gif",
      dark: "/images/marketing/darktheme/EmailMarketing.gif",
    },
  };
  ...
  const section2 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/EmailMarketing2.gif",
      dark: "/images/marketing/darktheme/EmailMarketing2.gif",
    },
  };
  ...
  const section3 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/EmailMarketing3.gif",
      dark: "/images/marketing/darktheme/EmailMarketing3.gif",
    },
  };
  ...
  const featuresData = [
    {
      ...
      paragraph:
        "Streamline communication effortlessly with automated workflows that nurture and convert",
    },
    {
      id: 1,
      icon: (
    ...
    },
    {
      ...
      paragraph:
        "Forge lasting connections through customized content that speaks directly to your audience",
    },
    {
      id: 1,
      icon: (
  ...
  return (
    <>
      ...
      <ConsultComp
        imageSrc="/images/consult/email-marketing.png"
        title="Email"
        titleColor="gray-800"
      ...
      <AccordianComp
        ...
        title="Why Choose Us ?"
        paragraph="Fresh Spar Technologies specializes in crafting personalized and engaging email campaigns that drive customer engagement, nurture leads, and boost conversions for your business."
        accordionItems={[
          {
            title: "Email Campaign Strategy",
            content:
              "We develop tailored email marketing strategies that leverage segmentation, personalization, and automation to deliver the right message to the right audience at the right time.",
          },
          {
            title: "Compelling Email Designs",
            content:
              "Our creative team designs visually appealing and responsive email templates that enhance brand perception and encourage recipients to take action.",
          },
          {
            title: "Performance Tracking and Optimization",
            content:
              "We monitor email campaign performance metrics in real-time and utilize A/B testing and data analysis to optimize campaigns for better engagement and conversion rates.",
          },
        ]}
      />
    </>
