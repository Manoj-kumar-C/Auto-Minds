...
import AccordianComp from "@/components/ui/AccordianComp";
import SectionComp from "@/components/ui/SectionComp";
import ConsultComp from "@/components/ui/consultComp";
import FeatureComp from "@/components/ui/FeatureComp";

function page() {
  const title2ClassName = "text-blue-600 dark:text-blue-500";
  const section1 = {
    title: "Wordpress",
    title2: "& CMS Development",
    paragraph:
      "We have experienced developers in various Domains to convert your dreams into reality",
    list1: [
      "LMS Systems",
    ...
    image: {
      light: "/images/marketing/whitetheme/SMM.gif",
      dark: "/images/marketing/darktheme/SMM.gif",
    },
  };
  ...
  const section2 = {
    ...
    title2: "Choose Us ?",
    paragraph:
      "Fresh Spar Technologies has team of experts access to cutting edge technology in web development.",
    details: [
      {
        title: "Experts in Planning",
        description:
          "We aim to create carefully planned web designs that are a reflection of your brand.",
      },
      {
    ...
    image: {
      light: "/images/marketing/whitetheme/SMM2.gif",
      dark: "/images/marketing/darktheme/SMM2.gif",
    },
  };
  ...
  const section3 = {
    ...
    paragraph:
      "We have experienced developers in various Domains to convert your dreams into reality",
    list1: ["Premium quality", "Maintainence", "Security Support"],
    list2: ["Highly Customizable", "Rich documentation", "Developer friendly"],
    image: {
      light: "/images/marketing/whitetheme/SMM3.gif",
      dark: "/images/marketing/darktheme/SMM3.gif",
    },
  };
  ...
  const featuresData = [
    {
      ...
      paragraph:
        "From page to advertisements, we compile every aspect of Facebook into our campaign to generate results",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "We are an all-rounder when it comes to Instagram feed, reels, IGTV, stories, and much more.",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "From sharing content, networking, and advertising on LinkedIn - we do it all.",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "We create engaging, viral video content that connects with the audience",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "We develop SMO-related strategies to increase brand awareness and connect with customers",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "We aid in monitoring and improving your brand’s online presence for driving better results.",
    },
  ...
  return (
    <>
      ...
      <ConsultComp
        imageSrc="/images/hero/technology.png"
        title="Social Media"
        titleColor="gray-800"
        subtitle="Marketing Services"
        subtitleColor="text-orange-400"
        subtitleColor2="dark:text-orange-400"
        description="Transform your online presence into web solutions"
        descriptionColor="g ray-700"
        buttonColor="hover:bg-orange-600 bg-orange-500"
      ...
      <SectionComp
        ...
        section2={section2}
        section3={section3}
        title2ClassName={title2ClassName}
      />
      <FeatureComp featuresData={featuresData} />
      <Brands />
      <Testimonials />
      <AccordianComp
        imageSrcLight="/images/others/accordian-white.gif"
        imageSrcDark="/images/others/accordian-dark.gif"
        title="Why Choose Us for Social Media Marketing?"
        paragraph="Fresh Spar Technologies delivers results-driven social media marketing strategies that enhance brand awareness, foster community engagement, and drive business growth across various social platforms."
        accordionItems={[
          {
            title: "Social Media Strategy Development",
            content:
              "We develop tailored social media strategies that align with your business goals and target audience, leveraging the strengths of each platform to maximize reach and engagement.",
          },
          {
            title: "Engaging Content Creation",
            content:
              "Our creative team produces captivating and shareable content, including posts, videos, and ads, optimized for each social media channel to resonate with your audience and spark interactions.",
          },
          {
            title: "Community Management and Analytics",
            content:
              "We actively manage and engage with your social media community, responding to comments, messages, and feedback, while also tracking performance metrics and providing actionable insights for continuous improvement.",
          },
        ]}
      />
    </>
