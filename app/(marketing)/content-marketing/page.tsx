...
function page() {
  ...
  const section1 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/ContentMarketing.gif",
      dark: "/images/marketing/darktheme/ContentMarketing.gif",
    },
  };
  ...
  const section2 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/ContentMarketing2.gif",
      dark: "/images/marketing/darktheme/ContentMarketing2.gif",
    },
  };
  ...
  const section3 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/ContentMarketing3.gif",
      dark: "/images/marketing/darktheme/ContentMarketing3.gif",
    },
  };
  ...
  const featuresData = [
    {
      ...
      paragraph: "Our team has 5+ years of experience in the digital industry",
    },
    {
      id: 1,
      icon: (
      ...
      title: "Wide Range",
      paragraph: "DigiNadu provide wide range of content marketing services",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph: "We provide dedicated manager to guide & update you",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "A strategic plan & review with the transparent report is what differentiates us from others",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "Time & effort on Content research & study transforms your brand reach",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "Our content team with proven industry knowledge can produce content",
    },
  ...
  return (
    <>
      ...
      <ConsultComp
        imageSrc="/images/consult/content-marketing.png"
        title="Content Creation "
        titleColor="gray-800"
        subtitle=" & Marketing Services"
        subtitleColor="text-green-400"
        subtitleColor2="dark:text-green-400"
        description="Transform your online presence into web solutions"
        descriptionColor="gray-700"
        buttonColor="hover:bg-green-600 bg-green-400"
      ...
      <AccordianComp
        ...
        title="Why Choose Us ?"
        paragraph="Fresh Spar Technologies offers comprehensive content marketing services aimed at attracting, engaging, and converting your target audience through valuable and relevant content."
        accordionItems={[
          {
            title: "Content Strategy Development",
            content:
              "We develop data-driven content strategies aligned with your business goals, ensuring that your content resonates with your audience and drives desired actions.",
          },
          {
            title: "Compelling Content Creation",
            content:
              "Our team of skilled writers and creators produces high-quality, engaging content in various formats, including articles, blog posts, videos, and infographics, to capture audience attention and inspire action.",
          },
          {
            title: "Content Distribution and Promotion",
            content:
              "We leverage various channels and platforms to distribute and promote your content effectively, maximizing its reach and impact across your target audience.",
          },
        ]}
      />
    </>
