...
function page() {
  ...
  const section1 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/SEO.gif",
      dark: "/images/marketing/darktheme/SEO.gif",
    },
  };
  ...
  const section2 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/SEO2.gif",
      dark: "/images/marketing/darktheme/SEO2.gif",
    },
  };
  ...
  const section3 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/SEO3.gif",
      dark: "/images/marketing/darktheme/SEO3.gif",
    },
  };
  ...
  const featuresData = [
    {
      ...
      paragraph:
        "Put your business on the map – our Local SEO Services ensure that your local presence shines.",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "our Technical SEO Services optimize the engine that drives your website, making it one of the top-tier rankings",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "our E-commerce SEO Services fine-tune your online store, ensuring that each click is a step closer to a sale",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "our SEO Analytics and Reporting decode the data, transforming insights into action and elevating your SEO strategy",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "our Voice Search Optimization ensures your brand's resonance in the era of hands-free exploration and discovery.",
    },
    {
      id: 1,
      icon: (
      ...
      paragraph:
        "Our content team with proven industry knowledge can boost your SEO results",
    },
  ...
  return (
    <>
      ...
      <AccordianComp
        ...
        title="Why Choose Us for SEO Optimization?"
        paragraph="Fresh Spar Technologies employs proven SEO strategies and techniques to improve your website's visibility, ranking, and organic traffic, driving sustainable growth for your business."
        accordionItems={[
          {
            title: "Comprehensive SEO Audits",
            content:
              "We conduct in-depth SEO audits to identify technical issues, keyword opportunities, and areas for optimization on your website.",
          },
          {
            title: "On-Page and Off-Page Optimization",
            content:
              "We optimize on-page elements, including meta tags, content, and site structure, while also executing effective off-page strategies such as link building and content promotion to improve your website's authority and relevance.",
          },
          {
            title: "Performance Monitoring and Reporting",
            content:
              "We continuously monitor SEO performance metrics and provide detailed reports, insights, and recommendations to track progress and drive ongoing optimization efforts.",
          },
        ]}
      />
    </>
