...
function page() {
  ...
  const section1 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/Ads.gif",
      dark: "/images/marketing/darktheme/Ads.gif",
    },
  };
  ...
  const section2 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/Ads2.gif",
      dark: "/images/marketing/darktheme/Ads2.gif",
    },
  };
  ...
  const section3 = {
    ...
    image: {
      light: "/images/marketing/whitetheme/Ads3.gif",
      dark: "/images/marketing/darktheme/Ads3.gif",
    },
  };
  ...
  const featuresData = [
    {
      ...
      title: "Google Ads",
      paragraph:
        "We have experienced persons at advertising campaigns to improve your ROI",
    },
    {
      id: 1,
      icon: (
    ...
    },
    {
      ...
      title: "Linkedin Ads",
      paragraph:
        "Linkedin Ads are costlier but we give ads at right audiences with right budget",
    },
    {
      id: 1,
      icon: (
      ...
      title: "Twitter Ads",
      paragraph:
        "Our Content at the ads creates the engaging, viral video content that connects with the audience.",
    },
    {
      id: 1,
      icon: (
  ...
  return (
    <>
      ...
      <ConsultComp
        imageSrc="/images/consult/ad-campaigns.png"
        title="Advertising"
        titleColor="gray-800"
        subtitle="Campaigns Services"
      ...
      <AccordianComp
        ...
        title="Why Choose Us for Ad Campaigns?"
        paragraph="Fresh Spar Technologies specializes in creating impactful ad campaigns that drive engagement, increase brand visibility, and deliver measurable results for your business."
        accordionItems={[
          {
            title: "Strategic Campaign Planning",
            content:
              "We develop comprehensive ad campaign strategies tailored to your business objectives and target audience, ensuring maximum reach and effectiveness.",
          },
          {
            title: "Compelling Ad Creatives",
            content:
              "Our team of creative experts crafts visually appealing and compelling ad creatives that resonate with your audience and effectively convey your message.",
          },
          {
            title: "Data-Driven Optimization",
            content:
              "We continuously monitor and analyze campaign performance metrics to optimize ad placements, messaging, and targeting, maximizing your return on investment.",
          },
        ]}
      />
    </>
